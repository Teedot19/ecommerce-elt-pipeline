...
class EcommerceDataGenerator:
    ...
    CAMPAIGN = [
                    'Summer Sale ', 'Black Friday Blitz', 'Customer Acquisition',
                    'Flash Friday', 'Brand Refresh', 'Holiday Special',
                    'Loyalty Rewards', 'Social Media Blast', 'Q1 2024 Growth'
                ]
    ...
    def _rows(self, table: str, initial: bool) -> int:
        ...
        return (
            self.initial_rows.get(table, 0)
            if initial
            else self.daily_rows.get(table, 0)
        )
