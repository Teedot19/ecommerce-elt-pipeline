...
def validate_payment_rows(
    ...
    valid_models, invalid_models = validate_records(rows, Payment)
...
def ingest_payments(day_folder: Path, run_dt: date, bucket: str) -> Dict[str, Any]:
    entity = "payments"
    ...
    # 2. Validate
    cleaned, invalid = validate_payment_rows(rows)
